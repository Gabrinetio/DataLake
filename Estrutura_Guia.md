...
Este repositório contém o código-fonte e a documentação para a construção de uma plataforma de dados ponta-a-ponta, totalmente auto-hospedada (*self-hosted*), com o objetivo de prever o **churn (cancelamento) de clientes**.

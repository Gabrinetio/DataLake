# Replica Node (Opcional) - Setup (Checklist ⚡)
...
**Início:** 2025-12-07
**Objetivo:** Este documento descreve um procedimento opcional para provisionar um nó de réplica com Spark + MinIO para replicação e alta disponibilidade.

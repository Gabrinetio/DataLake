...
📖 **[`docs/VARIÁVEIS_ENV.md`](VARIÁVEIS_ENV.md)** — Guia completo com exemplos
...
└── PROBLEMAS_ESOLUCOES.md  # Registro histórico de erros e correções
```
...
4. Verificar `docs/PROBLEMAS_ESOLUCOES.md` ao lidar com erros, evitando reincidências.
...
```json
{
  "github.copilot.chat.workspaceInstructions": "Neste repositório, SEMPRE consulte e respeite os arquivos docs/CONTEXT.md e docs/PROBLEMAS_ESOLUCOES.md. Todas as sugestões devem seguir seus padrões e decisões.",
  
  "copilot.customInstructions": "Responder sempre em português (BR). Manter simplicidade, segurança e conformidade com docs/CONTEXT.md e docs/PROBLEMAS_ESOLUCOES.md."
}
```
...
### **Dados de Teste:**
- `data_gen_backup_results.json` - Resultados Iter 4
- `disaster_recovery_results.json` - Resultados DR
- `security_hardening_results.json` - Auditoria segurança
- `compaction_results.json` - Resultados Iter 3
